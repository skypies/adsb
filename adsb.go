...
type Msg struct {
	// This set of data is basically the SBS1 format.

	Type string // = 0 // type	 (MSG, STA, ID, AIR, SEL or CLK)
	...
	Icao24 IcaoId // [represent as []byte ?]  = 4 //	 Aircraft Mode S hexadecimal code
	...
	// Flags filled during parsing, interrogated by methods below
	hasPosition bool
}
